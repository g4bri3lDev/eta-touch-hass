...
STATE_ICONS: dict[str, str] = {
    ...
    "starting": "mdi:flash",  # ignition, not a warning
    "heating": "mdi:fire",
    ...
    "demand": "mdi:progress-clock",
    "suction": "mdi:vacuum",
    "conveying": "mdi:screw-lag",
    "discharge_overrun": "mdi:screw-lag",
    "turbine_overrun": "mdi:vacuum-outline",
...
ICONS: dict[str, str] = {
    ...
    "ignition": "mdi:flash",  # ignition output, not a warning
    "suction_turbine": "mdi:vacuum",
    ...
    "curve_offset": "mdi:tune-vertical-variant",
    ...
    "hot_water_charge_now": "mdi:water-plus",
    "buffer_charge_now": "mdi:storage-tank-outline",
    "fill_pellet_container": "mdi:vacuum",
